...
To run the Java wrapper you need to download a Java SDK. Sun JDK
1.4.1 was used to build the wrapper.  You can download it from:

    http://java.sun.com/j2se/1.4.1/download.html

You should install it on your system.  Then you should put the bin
directory of the SDK into your path.  
...
--
$Id: README.txt,v 1.5 2007-02-23 21:07:27 reed Exp $
