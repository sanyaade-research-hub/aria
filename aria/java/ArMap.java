...
public class ArMap extends ArMapInterface {
  ...
  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection, String configParam, String configDesc, boolean ignoreEmptyFileName, ArPriority.Priority priority, String tempDirectory) {
    this(AriaJavaJNI.new_ArMap__SWIG_0(baseDirectory, addToGlobalConfig, configSection, configParam, configDesc, ignoreEmptyFileName, priority.swigValue(), tempDirectory), true);
  ...
  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection, String configParam, String configDesc, boolean ignoreEmptyFileName, ArPriority.Priority priority) {
    this(AriaJavaJNI.new_ArMap__SWIG_1(baseDirectory, addToGlobalConfig, configSection, configParam, configDesc, ignoreEmptyFileName, priority.swigValue()), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }
  ...
  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection, String configParam, String configDesc, boolean ignoreEmptyFileName) {
    this(AriaJavaJNI.new_ArMap__SWIG_2(baseDirectory, addToGlobalConfig, configSection, configParam, configDesc, ignoreEmptyFileName), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection, String configParam, String configDesc) {
    this(AriaJavaJNI.new_ArMap__SWIG_3(baseDirectory, addToGlobalConfig, configSection, configParam, configDesc), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection, String configParam) {
    this(AriaJavaJNI.new_ArMap__SWIG_4(baseDirectory, addToGlobalConfig, configSection, configParam), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(String baseDirectory, boolean addToGlobalConfig, String configSection) {
    this(AriaJavaJNI.new_ArMap__SWIG_5(baseDirectory, addToGlobalConfig, configSection), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(String baseDirectory, boolean addToGlobalConfig) {
    this(AriaJavaJNI.new_ArMap__SWIG_6(baseDirectory, addToGlobalConfig), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(String baseDirectory) {
    this(AriaJavaJNI.new_ArMap__SWIG_7(baseDirectory), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap() {
    this(AriaJavaJNI.new_ArMap__SWIG_8(), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }

  public ArMap(ArMap other) {
    this(AriaJavaJNI.new_ArMap__SWIG_9(ArMap.getCPtr(other), other), true);
    AriaJavaJNI.ArMap_director_connect(this, swigCPtr, swigCMemOwn, true);
  }
  ...
  public void addMapChangedCBPos(ArFunctor functor, ArListPos.Pos position) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addMapChangedCBPos(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue()); else AriaJavaJNI.ArMap_addMapChangedCBPosSwigExplicitArMap(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }

  public void addMapChangedCB(ArFunctor functor) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addMapChangedCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor); else AriaJavaJNI.ArMap_addMapChangedCBSwigExplicitArMap(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }
  ...
  public void addPreMapChangedCBPos(ArFunctor functor, ArListPos.Pos position) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addPreMapChangedCBPos(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue()); else AriaJavaJNI.ArMap_addPreMapChangedCBPosSwigExplicitArMap(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }

  public void addPreMapChangedCB(ArFunctor functor) {
    if (getClass() == ArMap.class) AriaJavaJNI.ArMap_addPreMapChangedCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor); else AriaJavaJNI.ArMap_addPreMapChangedCBSwigExplicitArMap(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }
