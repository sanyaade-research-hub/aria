...
public class ArMapSimple extends ArMapInterface {
  ...
  public void addMapChangedCBPos(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapSimple_addMapChangedCBPos(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }

  public void addMapChangedCB(ArFunctor functor) {
    AriaJavaJNI.ArMapSimple_addMapChangedCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }
  ...
  public void addPreMapChangedCBPos(ArFunctor functor, ArListPos.Pos position) {
    AriaJavaJNI.ArMapSimple_addPreMapChangedCBPos(swigCPtr, this, ArFunctor.getCPtr(functor), functor, position.swigValue());
  }

  public void addPreMapChangedCB(ArFunctor functor) {
    AriaJavaJNI.ArMapSimple_addPreMapChangedCB(swigCPtr, this, ArFunctor.getCPtr(functor), functor);
  }
